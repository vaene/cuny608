...
export const STORY4_SLIDES = [
  { href: "/608/Story4", label: "Intro" },
  { href: "/608/Story4/roles", label: "Role" },
  { href: "/608/Story4/levels", label: "Level" },
  { href: "/608/Story4/region", label: "Region" },
  { href: "/608/Story4/region-role", label: "Region x Role" },
  { href: "/608/Story4/sources", label: "Sources" }
] as const;
