...
export default function Story4Home() {
  return (
    <StoryShell
      currentPath="/608/Story4"
      title="How Much Do Data Practitioners Get Paid?"
      subtitle="Exploring salary patterns across roles, experience levels, and geography using Bureau of Labor Statistics data."
    >
        ...
        <section className="flex flex-col justify-center">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-base leading-7 text-gray-700">
              This data story ranks different data professions, shows how compensation grows from junior to senior levels, compares regions, and breaks down regional patterns by role.
            </p>
            <p className="mt-4 text-base leading-7 text-gray-700">
              Built with Next.js and Chart.js, this interactive presentation uses static JSON data served locally for fast, deployable visualizations.
            </p>
