...
const LOCAL_BUNDLE_URL = "https://cuny.drinkthesand.com/608/Story4.2/Story4.2-local-bundle.zip";
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <section className="rounded-2xl border border-blue-200 bg-blue-50 p-6">
          <h2 className="text-lg font-semibold text-blue-900">Local Bundle</h2>
          <p className="mt-3 text-sm leading-6 text-blue-900">
            Download the packaged local project here:
          </p>
          <a
            href={LOCAL_BUNDLE_URL}
            className="mt-4 inline-flex w-fit items-center rounded-full bg-blue-900 px-4 py-2 text-sm font-medium text-white transition hover:bg-blue-800"
          >
            Story4.2 Local Bundle
          </a>
        </section>
      </div>
    </StoryShell>
