  ...
  useEffect(() => {
    ...
    async function renderChart() {
      try {
        ...
        type ColaChartPoint = BubbleDataPoint | Point;
        type ColaDataset = ChartDatasetCustomTypesPerDataset<"bubble" | "line", ColaChartPoint[]>;

        const bubbleDatasets: ColaDataset[] = regions.map((region) => {
        ...
        const trendlineDataset: ColaDataset = {
          label: "Trend",
          data: trendlineData,
          type: "line",
          borderColor: "#9CA3AF",
        ...
        const config: ChartConfigurationCustomTypesPerDataset<"bubble" | "line", ColaChartPoint[], unknown> = {
          data: {
                ...
                callbacks: {
                  ...
                  label(context: TooltipItem<"bubble" | "line">) {
                    if (context.dataset.type === "line") {
                      ...
                      return `Trend: COLA ${point.x}, projected salary ${formatCurrency(point.y ?? 0)}`;
                    }

                    const point = context.raw as BubbleDataPoint;
                    return `COLA: ${point.x} | Avg Salary: ${formatCurrency(point.y ?? 0)}`;
                  }
                }
              }
            },
      ...
      <div className="flex h-full flex-col">
        <section className="mb-8 rounded-2xl border border-blue-200 bg-blue-50 p-6">
          ...
          <p className="mt-2 text-sm leading-6 text-blue-900">
            ...
            of the geographic salary pattern. Mouse over for salary info.
          </p>
        </section>
