...
const remoteBaselinePlugin: Plugin<"bar"> = {
  ...
  afterDatasetsDraw(chart) {
    ...
    ctx.fillText(`Remote average ${formatCurrencyCompact(118500.2)}`, x + 8, top - 6);
    ctx.restore();
  }
};
    ...
    async function renderChart() {
      try {
        ...
        const barColors = comparisonRegions.map((record) => {
          const baseColor = record.deltaFromRemote >= 0 ? POSITIVE_COLOR : NEGATIVE_COLOR;
          return hexToRgba(baseColor, 0.82);
        });
        const borderColors = comparisonRegions.map((record) =>
          record.deltaFromRemote >= 0 ? POSITIVE_COLOR : NEGATIVE_COLOR
        );
      ...
      <div className="flex h-full flex-col">
        <section className="mb-8 rounded-2xl border border-blue-200 bg-blue-50 p-6">
          ...
          <p className="mt-2 text-sm leading-6 text-blue-900">
            ...
            making the geography story easier to compare after averaging across roles. Mouse over bars for more info.
          </p>
        </section>
        ...
        <div className="mt-8 space-y-4 border-t border-gray-200 pt-6">
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-lg bg-red-50 p-4">
              <h3 className="font-semibold text-red-900">Below Remote</h3>
            ...
            <div className="rounded-lg bg-amber-50 p-4">
              <h3 className="font-semibold text-black-900">Middle Tier</h3>
              <p className="mt-1 text-sm text-black-800">
            ...
            <div className="rounded-lg bg-green-50 p-4">
              <h3 className="font-semibold text-green-900">Urban High-COLA Regions</h3>
