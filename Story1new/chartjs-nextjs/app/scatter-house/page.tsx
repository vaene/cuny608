...
export default function ScatterHousePage() {
  ...
  const chartDescription =
    'Why it matters: this tests whether spending deltas align with 2024 House outcomes.';
  const sources =
    'USAspending.gov API (FY2017–FY2024), Census population by fiscal year, 2024 House results, 2020 winner map.';
  const methods =
    'Compute per-capita delta and plot against 2024 House margin; fit linear trend with R2 and p-value; show Spearman rho and quadrant counts.';
