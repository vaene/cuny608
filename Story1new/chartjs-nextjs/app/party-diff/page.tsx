...
export default function PartyDiffPage() {
  ...
  const chartDescription =
    'Why it matters: this tests whether post-2020 spending changes differ meaningfully by partisan outcome.';
  const sources =
    'USAspending.gov API (FY2017–FY2024), Census population by fiscal year, 2020 presidential winner map.';
  const methods =
    'Compute per-capita delta (FY2021–FY2024 avg minus FY2017–FY2020 avg) and compare means with 95% CI; show full distributions.';
