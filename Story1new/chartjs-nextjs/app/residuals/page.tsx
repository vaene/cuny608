...
export default function ResidualsPage() {
  ...
  const chartDescription =
    'Why it matters: residuals show where the model fails, highlighting states not explained by spending changes.';
  const sources =
    'USAspending.gov API (FY2017–FY2024), Census population by fiscal year, 2024 presidential results.';
  const methods =
    'Fit a linear model of margin vs per-capita delta and plot residuals by state.';
