  ...
  return (
    <main className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="mx-auto max-w-6xl rounded-lg bg-white p-6 pb-16 shadow flex flex-col h-screen">
        ...
        <div className="rounded-md border-l-4 border-blue-600 bg-blue-50 px-4 py-3 text-sm text-blue-900">
          <div className="font-semibold">Answer to the question</div>
          <div>Spending increased broadly in 2021–2024, but alignment with 2024 voting margins is weak.</div>
        </div>
        ...
        <div className="mt-3 rounded-lg border border-gray-100 bg-gray-50 px-4 py-3 text-sm leading-relaxed text-gray-700">
          The IIJA snapshot motivates a broader look at total obligations. The Biden-era increase is
          broad-based across states, but scatter plots and residuals show only modest associations with 2024
          presidential and House margins. States with similar spending deltas often voted differently, so
          spending changes alone do not explain 2024 outcomes.
        </div>
