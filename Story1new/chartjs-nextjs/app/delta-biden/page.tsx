...
export default function DeltaBidenPage() {
  ...
  const chartDescription =
    'Why it matters: this summarizes the magnitude and distribution of spending increases before linking to election outcomes.';
  const sources =
    'USAspending.gov API (FY2017–FY2024), Census population by fiscal year, 2020 presidential winner map.';
  const methods =
    'Compute per-capita delta (FY2021–FY2024 avg minus FY2017–FY2020 avg); sort states by delta; color by 2020 winner.';
    ...
    <main className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="mx-auto max-w-6xl rounded-lg bg-white p-5 pb-16 shadow flex flex-col h-screen">
        ...
        <div className="fixed bottom-2 left-1/2 -translate-x-1/2 z-20 flex items-center gap-3 rounded-full border border-gray-200 bg-white/65 px-4 py-1 text-xs text-gray-600 shadow-md backdrop-blur scale-75 origin-bottom">
          <span className="font-semibold text-gray-900"> 10 / 11 </span>
