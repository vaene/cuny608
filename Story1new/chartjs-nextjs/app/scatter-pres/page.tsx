...
export default function ScatterPresPage() {
  ...
  const chartDescription =
    'Why it matters: this directly tests whether spending deltas align with 2024 presidential outcomes.';
  const sources =
    'USAspending.gov API (FY2017–FY2024), Census population by fiscal year, 2024 presidential results, 2020 winner map.';
  const methods =
    'Compute per-capita delta and plot against 2024 margin; fit linear trend with R2 and p-value; show Spearman rho and quadrant counts.';
