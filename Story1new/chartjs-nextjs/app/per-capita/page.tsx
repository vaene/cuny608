...
export default function PerCapitaPage() {
  ...
  const chartDescription =
    'Why it matters: per-capita spending removes population scale effects and reveals which states truly gained more per person.';
  const sources =
    'USAspending.gov API (FY2017–FY2024), Census population by fiscal year, 2020 presidential winner map.';
  const methods =
    'Convert obligations to per-capita using fiscal-year population; compare FY2017–FY2020 average to FY2024; order by maximum.';
