...
export default function Home() {
  ...
  const chartDescription =
    'This chart expands beyond the IIJA snapshot by showing total federal obligations by state in FY2024 versus the pre-Biden baseline (FY2017–FY2020). States are ordered by maximum spending, with each state showing two bars: the lighter bar represents the historical average, and the darker bars show FY2024 levels. Colors represent the 2020 presidential election winner in each state, revealing how overall spending changed across political contexts.';
  const keyObservations =
    'Key observations: Major spenders remain large-population states, while the FY2024 bar reveals how totals shift versus the pre-Biden baseline. This broader view helps interpret the IIJA snapshot in the context of overall federal obligations.';
