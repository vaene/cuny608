...
export default function BinnedPage() {
  ...
  const chartDescription =
    'This binned scatter averages states by spending-delta bins, then plots average 2024 margins. If spending deltas drove results, the lines would be steep and consistent.';
  const keyObservations =
    'Key observations: The binned averages rise only modestly and still show variability, reinforcing that spending deltas are not strong predictors of 2024 outcomes.';
