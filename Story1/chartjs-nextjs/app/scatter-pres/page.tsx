...
export default function ScatterPresPage() {
  ...
  const chartDescription =
    'This scatter plot compares the Biden-era average (FY2021–FY2024) to the pre-Biden baseline (FY2017–FY2020) and asks whether larger per-capita spending increases align with 2024 presidential margins. Each point is a state (plus DC), colored by its 2020 winner.';
  const keyObservations =
    'Key observations: The association is moderately positive, but points are widely dispersed. All states show positive spending change in this timeframe, split between Dem margins (20) and GOP margins (31). Outliers include KY, VT, WY, WV, and MD.';
    ...
    <main className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="mx-auto max-w-6xl rounded-lg bg-white p-5 pb-16 shadow flex flex-col h-screen">
        ...
        <Link
          ...
          aria-label="Go to binned averages"
        >
        ...
        <div className="fixed bottom-2 left-1/2 -translate-x-1/2 z-20 flex items-center gap-3 rounded-full border border-gray-200 bg-white/65 px-4 py-1 text-xs text-gray-600 shadow-md backdrop-blur scale-75 origin-bottom">
          <span className="font-semibold text-gray-900">7 / 11</span>
